...
@section('content')
            ...
            <div class="modal-content">
                <form action="{{ route('manajer.bulk.reject.detail') }}" method="POST" id="bulkRejectForm">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="bulkRejectNotes" class="form-label">Alasan Penolakan <span class="text-danger">*</span></label>
                            <textarea name="approval_notes" id="bulkRejectNotes" rows="3" class="form-control" placeholder="Jelaskan alasan penolakan..." required></textarea>
                        </div>
    ...
    <div class="modal fade" id="bulkReviseModal" tabindex="-1" aria-labelledby="bulkReviseModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('manajer.bulk.revise.detail') }}" method="POST" id="bulkReviseForm">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="bulkReviseNotes" class="form-label">Catatan Revisi <span class="text-danger">*</span></label>
                            <textarea name="approval_notes" id="bulkReviseNotes" rows="3" class="form-control" placeholder="Instruksi revisi untuk karyawan..." required></textarea>
                        </div>
