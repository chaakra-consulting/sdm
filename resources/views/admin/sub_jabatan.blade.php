                        ...
                        @foreach($sub_jabatan as $row)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="/admin/sub_jabatan/delete/{{ $row->id }}" method="POST" class="d-inline">
                                        @csrf
                                        @method('DELETE')
...
<script>
    $(document).ready(function(){
      ...
      $(".tambahSubJabatan").click(function(){
        ...
        $("#formSubJabatan").attr('action', '/admin/sub_jabatan/store');
      })
      ...
      $(".editSubJabatan").click(function(e){
        ...
        $("#formSubJabatan").attr('action', '/admin/sub_jabatan/update/' + $(this).data('id'));
      })
    })
</script>
@endsection