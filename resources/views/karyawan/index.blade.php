            ...
            <div class="col-xl-12">
                <div class="card custom-card">
                    ...
                    <div class="card-body">
                        ...
                        @else
                            @if (Auth::user()->role->slug == 'admin-sdm')
                                <form action="{{ route('admin_sdm.datadiri.update', $datadiri->id) }}" method="POST"
                                ...
                                @elseif (Auth::user()->role->slug == 'karyawan')
                                    ...
                                    @elseif (Auth::user()->role->slug == 'manager')
                                        <form action="{{ route('manajer.datadiri.update', $datadiri->id) }}" method="POST"
                                            enctype="multipart/form-data">
                            @endif
                            @csrf
                            @method('put')
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nama_emergency" name="nama_emergency"
                                        placeholder="Masukkan Nomor HP" value="{{ $datadiri->nama_emergency }}" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="no_emergency" name="no_emergency"
                                        placeholder="Masukkan Nomor HP" value="{{ $datadiri->no_emergency }}" required>
                                </div>
                                <div class="col-md-6 mb-3">
                    ...
                    <div class="card-body">
                        ...
                        @else
                            @if (Auth::check() && Auth::user()->role->slug == 'admin-sdm')
                                <form action="{{ route('admin_sdm.pendidikan.update', $pendidikan->id) }}" method="POST"
                                    enctype="multipart/form-data">
                                @elseif (Auth::check() && Auth::user()->role->slug == 'karyawan')
                                    <form action="{{ route('karyawan.pendidikan.update', $pendidikan->id) }}"
                                        method="POST" enctype="multipart/form-data">
                                    @elseif (Auth::check() && Auth::user()->role->slug == 'manager')
                                        <form action="{{ route('manajer.pendidikan.update', $pendidikan->id) }}"
                                            method="POST" enctype="multipart/form-data">
                            @endif
                            @csrf
                            @method('PUT')
                ...
                <div class="row">
                    <div class="card custom-card">
                        ...
                        <div class="card-body">
                            ...
                            @if (Auth::check() && Auth::user()->role->slug == 'admin-sdm')
                                <form
                                    action="{{ !$kesehatan ? route('admin_sdm.kesehatan.store') : route('admin_sdm.kesehatan.update', $kesehatan->id) }}"
                                    method="POST" enctype="multipart/form-data">
                                @elseif (Auth::check() && Auth::user()->role->slug == 'karyawan')
                                    <form
                                        action="{{ !$kesehatan ? route('karyawan.kesehatan.store') : route('karyawan.kesehatan.update', $kesehatan->id) }}"
                                        method="POST" enctype="multipart/form-data">
                                    @elseif (Auth::check() && Auth::user()->role->slug == 'manager')
                                        <form
                                            action="{{ !$kesehatan ? route('manajer.kesehatan.store') : route('manajer.kesehatan.update', $kesehatan->id) }}"
                                            method="POST" enctype="multipart/form-data">
                            @endif
                            @csrf
                            @if ($kesehatan)
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    @if (Auth::check() && Auth::user()->role->slug == 'admin-sdm')
                        <form action="{{ route('admin_sdm.datadiri.store') }}" method="POST"
                            enctype="multipart/form-data">
                        @elseif (Auth::check() && Auth::user()->role->slug == 'karyawan')
                            <form action="{{ route('karyawan.datadiri.store') }}" method="POST"
                                enctype="multipart/form-data">
                            @elseif (Auth::check() && Auth::user()->role->slug == 'manager')
                                <form action="{{ route('manajer.datadiri.store') }}" method="POST"
                                    enctype="multipart/form-data">
                    @endif
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select mb-1" name="hubungan_emergency" id="hubungan_emergency" required>
                            ...
                            <input type="text" class="form-control mb-1" id="nama_emergency" name="nama_emergency"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <img id="preview_user" alt="Preview Foto User"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <!-- Preview gambar akan diupdate setelah pengguna memilih file -->
                            <img id="preview_ktp" alt="Preview Foto KTP"
                                style="max-width: 150px; margin-top: 10px; display: none;">
                            <small id="error_ktp" class="text-danger" style="display: none;"></small>
                        </div>
                        <div class="col-md-12">
    ...
    <div class="modal fade" id="modalTambahPendidikan" tabindex="-1" aria-labelledby="modalTambahPendidikanLabel"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    @if (Auth::check() && Auth::user()->role->slug == 'admin-sdm')
                        <form action="{{ route('admin_sdm.pendidikan.store') }}" method="POST"
                            enctype="multipart/form-data">
                        @elseif (Auth::check() && Auth::user()->role->slug == 'karyawan')
                            <form action="{{ route('karyawan.pendidikan.store') }}" method="POST"
                                enctype="multipart/form-data">
                            @elseif (Auth::check() && Auth::user()->role->slug == 'manager')
                                <form action="{{ route('manajer.pendidikan.store') }}" method="POST"
                                    enctype="multipart/form-data">
                    @endif
                    @csrf
                    <div class="row">
