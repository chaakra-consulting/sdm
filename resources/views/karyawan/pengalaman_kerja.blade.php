...
@section('content')
    ...
    <div class="modal fade" id="staticBackdropViewDokumenPdf" data-bs-backdrop="static" data-bs-keyboard="false"
                        ...
                        <tbody>
                            @foreach ($pengalaman_kerja as $row)
                                <tr>
                                    ...
                                    <td>
                                        <a href="" class="btn btn-danger btnViewDokumenPdf"
                                            data-nama_perusahaan="{{ $row->nama_perusahaan }}"
                                            data-dokumen_pdf="{{ asset('uploads/' . $row->upload_surat_referensi) }}">View
                                            Dokumen</a>
                                    </td>
                                    <td>
                                        <a href="" class="btn btn-warning editPengalaman" data-bs-toggle="modal"
                                            data-bs-target="#staticBackdrop" data-id_pengalaman="{{ $row->id }}"
                                            data-nama_perusahaan="{{ $row->nama_perusahaan }}"
                                            ...
                                            data-dokumen_pdf="{{ asset('uploads/' . $row->upload_surat_referensi) }}"><i
                                                class="fas fa-edit"></i></a>
                                        <form action="/karyawan/pengalaman_kerja/delete/{{ $row->id }}"
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.btnViewDokumenPdf').click(function(e) {
                ...
                $("#staticBackdropViewDokumenPdf .modal-title").text('Surat Referensi : ' + $(this).data(
                    'nama_perusahaan'));
            ...
            $(".editPengalaman").click(function(e) {
                ...
                $("#formPengalaman").attr('action', '/karyawan/pengalaman_kerja/update/' + $(this).data(
                    'id_pengalaman'));
            })
