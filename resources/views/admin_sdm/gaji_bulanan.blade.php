                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-group editGajiDropdown" style="display: none;">
                                ...
                                <input type="string" name="pegawai_nama" id="pegawai_nama"
                                    value= "pegawai_nama"class="form-control" disabled>
                            </div>
                        ...
                        <input type="text" name="gaji_pokok" id="gaji_pokok" value="{{ old('gaji_pokok') }}" class="form-control">
                            ...
                            <label class="d-block text-center fw-bold">
                                <h6>Gaji Pokok dan Tunjangan</h6>
                            </label>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="gaji_pokok">Gaji Pokok</label>
                                    <input type="text" name="gaji_pokok" id="gaji_pokok" value="{{ old('gaji_pokok') }}"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="insentif_uang_makan" id="insentif_uang_makan"
                                        value="{{ old('insentif_uang_makan') }}"class="form-control">
                                </div>
                            </div>
                            <label class="d-block text-center fw-bold">
                                <h6>Insentif</h6>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="potongan_bpjs_ketenagakerjaan"
                                        id="potongan_bpjs_ketenagakerjaan"
                                        value="{{ old('potongan_bpjs_ketenagakerjaan') }}"class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="potongan_bpjs_kesehatan" id="potongan_bpjs_kesehatan"
                                        value="{{ old('potongan_bpjs_kesehatan') }}"class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="insentif_kinerja">Kinerja</label>
                                    <input type="text" name="insentif_kinerja" id="insentif_kinerja"
                                        value="{{ old('insentif_kinerja', 0) }}" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="insentif_uang_bensin">Uang Bensin</label>
                                    <input type="text" name="insentif_uang_bensin" id="insentif_uang_bensin"
                                        value="{{ old('insentif_uang_bensin') }}"class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="insentif_penjualan">Penjualan</label>
                                    <input type="text" name="insentif_penjualan" id="insentif_penjualan"
                                        value="{{ old('insentif_penjualan') }}"class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="overtime" id="overtime"
                                        value="{{ old('overtime') }}"class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="insentif_lainnya">Lainnya</label>
                                    <input type="text" name="insentif_lainnya" id="insentif_lainnya"
                                        value="{{ old('insentif_lainnya') }}"class="form-control">
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="potongan_gaji_pokok" id="potongan_gaji_pokok"
                                        value="{{ old('potongan_gaji_pokok') }}"class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="potongan_uang_makan">Uang Makan</label>
                                    <input type="text" name="potongan_uang_makan" id="potongan_uang_makan"
                                        value="{{ old('potongan_uang_makan') }}"class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="potongan_keterlambatan">Keterlambatan</label>
                                    <input type="text" name="potongan_keterlambatan" id="potongan_keterlambatan"
                                        value="{{ old('potongan_keterlambatan') }}"class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="potongan_kinerja">Kinerja</label>
                                    <input type="text" name="potongan_kinerja" id="potongan_kinerja"
                                        value="{{ old('potongan_kinerja', 0) }}" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="potongan_pajak">Pajak</label>
                                    <input type="text" name="potongan_pajak" id="potongan_pajak"
                                        value="{{ old('potongan_pajak') }}"class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="potongan_kasbon">Kasbon</label>
                                    <input type="text" name="potongan_kasbon" id="potongan_kasbon"
                                        value="{{ old('potongan_kasbon') }}"class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="potongan_lainnya" id="potongan_lainnya"
                                        value="{{ old('potongan_lainnya') }}"class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="keterangan_potongan_lainnya" id="keterangan_potongan_lainnya"
                                        value="{{ old('keterangan_potongan_lainnya') }}" class="form-control" rows="3"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container-fluid">
        ...
        <div class="card custom-card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <button class="btn btn-sm btn-success ms-2" id="alert-parameter">Sinkronisasi Akun Gaji Buku Kas <i
                ...
                <p class="mb-0"><small><em><span class="text-danger">*</span>Wajib dilakukan sinkronisasi setelah gaji
                            final diverifikasi</em></small></p>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span style="color: green;">Rp.
                                            {{ number_format($row->gaji_total ?? 0, 0, ',', '.') }}</span>
                                    </td>
                                    <td>
                                        <a href="" class="btn btn-teal showGaji" data-bs-toggle="modal"
                                            data-bs-target="#staticBackdrop" title="Lihat"
                                            data-id="{{ $row->id }}" data-pegawai_id="{{ $row->pegawai_id }}"
                                        ...
                                        @if ($role == 'admin_sdm')
                                            <a href="" class="btn btn-warning editGaji" data-bs-toggle="modal"
                                                data-bs-target="#staticBackdrop" title="Edit"
                                                data-id="{{ $row->id }}" data-pegawai_id="{{ $row->pegawai_id }}"
                                                data-pegawai_nama="{{ $row->pegawai_nama ? $row->pegawai_nama : '-' }}"
                                                data-tanggal_gaji="{{ $row->tanggal_gaji }}"
                                                data-gaji_pokok="{{ $row->gaji_pokok }}"
                                        ...
                                        @endif
                                        <a href="/cetak-payslip/{{ $row->hash }}" class="btn btn-danger"
                                            data-bs-toggle="tooltip" data-bs-placement="top" title="Cetak Slip"
                                            data-id="{{ $row->id }}" target="_blank" rel="noopener noreferrer">
    ...
    <script>
        $(document).ready(function() {
            ...
            $(".editGaji").click(function(e) {
                ...
                $("#formGaji").attr('action', '/{{ $role }}/gaji_bulanan/update/' + $(this).data(
                    'id'));
            })
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href =
                        `/{{ $role }}/gaji_bulanan/sync?year=${year}&month=${month}`;
                }
