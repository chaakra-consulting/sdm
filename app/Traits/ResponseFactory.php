...
/**
 * @author Muhammad Adi Saputro <muhammadxxz7@gmail.com>
 * @package App\Traits
 * @codeCoverageIgnore
 * 
 * @method JsonResponse RespondError(mixed $message, int $statusCode = 400, Exception $exception = null, int $error_code = 1)
 * @method JsonResponse successResponse(mixed $message, int $status = 200)
 * @method JsonResponse successResponseData(mixed $message, mixed $data, int $status = 200)
 * @method JsonResponse successResponseWithPagination(mixed $message, mixed $data, int $status = 200)
 * @method JsonResponse emptyResponse(mixed $message, int $status = 200)
 * 
 */
